...
class TeamAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $teams = $this->teamRepository->with('lapang','user')->all();
    ...
    {
        /** @var Team $team */
        $team = $this->teamRepository->with('lapang','user')->findWithoutFail($id);
    ...
    public function destroy($id)
    {
     ...
     public function myteam($id_user)
    {
        /** @var Team $team */

        $team = Team::where('id_user',$id_user)->with('lapang')->first();
